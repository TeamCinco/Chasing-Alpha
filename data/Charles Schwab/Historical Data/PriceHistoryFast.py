...
# Cleaned stock_tickers (remove duplicates, non-US symbols if API is US-centric without modification)
# This is a quick pass; for 10k tickers, you'd have a proper list source.
# For now, I'll use the provided list as-is after minor corrections.
# Ensure your `all_tickers` list for 10k is properly formatted and valid for the API.
...
CONFIG = {
    ...
    'max_workers': 5,
    'request_delay': 0.05,  # MODIFIED: Reduced delay before API call
    'retry_attempts': 3,
    'retry_delay': 2,
    'max_pending_tasks': 20, # MODIFIED: Increased pending tasks
    'period_type': 'year',
    'period': 10,
