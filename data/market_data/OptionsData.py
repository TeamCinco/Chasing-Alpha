...
class SchwabOptionsStreamer:
    ...
    def get_user_preferences(self):
        url = "https://api.schwabapi.com/user/v1/preferences"
    ...
    def on_open(self, ws):
        ...
        subs_request = [{
            ...
            "parameters": {
                ...
                "fields": "0,2,3"  # Symbol, Bid Price, Ask Price
            }
        }]
...
def main():
    CONFIG = {
        ...
        'option_symbols': ['AAPL  230616C00150000', 'GOOGL 230616P02000000']  # Example option symbols
    }
